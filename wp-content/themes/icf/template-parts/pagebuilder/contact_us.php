...
$title = $section['title'] ?? "";
$intro = $section['intro'] ?? "";
$mailing_list_link = $section['mailing_list_link'] ?? "";
    ...
    <section class="contact-us" id="contact">
        <div class="inner-wrapper">
            ...
            <div class="contact-wrapper">
                ...
                <a href="{$mailing_list_link['url']}" target="{$mailing_list_link['target']}" class="primary fadeVert">
                    {$mailing_list_link['title']}
                </a>
                <div class="fadeVert">{$social_media_text}</div>
                <div class="social-icons">
                    <a class="instagram social-icon" href="{$instagram}" target="_blank">
                    ...
                    <a class="facebook social-icon" href="{$facebook}" target="_blank">
